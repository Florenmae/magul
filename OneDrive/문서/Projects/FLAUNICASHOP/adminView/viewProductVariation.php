...
<div >
  ...
  <table class="table ">
    ...
    <?php
      ...
      $sql="SELECT * from product_details v, product p, shop s WHERE p.product_id=v.product_id AND v.shop_id=s.shop_id ";
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' action="./controller/addVariationController.php" method="POST">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-secondary" name="upload" style="height:40px">Add New Product Variation</button>
            </div>
          </form>
